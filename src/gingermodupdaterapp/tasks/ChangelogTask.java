package gingermodupdaterapp.tasks;
...
import gingermodupdaterapp.changelog.ChangelogHandler;
import gingermodupdaterapp.customTypes.UpdateInfo;
import gingermodupdaterapp.customTypes.Version;
    ...
    public void onPostExecute(List<Version> result) {
        ...
        switch (mChangelogType) {
            case ROM:
                ...
                break;
            case EXTRA:
                dialogTitle = R.string.changelog_title_extra;
                break;
            case APP:
